...
public class User {
    ...
    // Constructor for registration (without role_id parameter, defaults to regular user)
    public User(String full_name, String email, String password) {
        this.full_name = full_name;
        this.email = email;
        this.password = password;
        this.role_id = 2; // Default to regular user
    }

    // Constructor for registration (with role_id parameter)
