...
public class ClothesDonationDAO {
    ...
    public boolean addClothesDonation(ClothesDonation donation) {
        String sql = "INSERT INTO clothes_donations (campaign_id, user_id, clothes_type, quantity, size, condition, pickup_address, pickup_date, status) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<ClothesDonation> getClothesDonationsByCampaign(int campaignId) {
        ...
        String sql = "SELECT * FROM clothes_donations WHERE campaign_id = ? ORDER BY created_at DESC";
    ...
    public List<ClothesDonation> getClothesDonationsByUser(int userId) {
        List<ClothesDonation> donations = new ArrayList<>();
        String sql = "SELECT * FROM clothes_donations WHERE user_id = ? ORDER BY created_at DESC";
    ...
    public boolean updateDonationStatus(int donationId, String status) {
        String sql = "UPDATE clothes_donations SET status = ? WHERE donation_id = ?";
