        ...
        <c:otherwise>
            <div class="campaigns-grid">
                <c:forEach var="campaign" items="${campaigns}">
                    <c:set var="progressPercentage" value="${campaign.goal_amount > 0 ? (campaign.collectedAmount / campaign.goal_amount) * 100 : 0}" />
                    <c:set var="cappedPercentage" value="${progressPercentage > 100 ? 100 : progressPercentage}" />
                    ...
                    <div class="campaign-card">
                        ...
                        <div class="campaign-content">
                            ...
                            <!-- General Campaign Info Row -->
                            <div class="campaign-stats">
                                <c:choose>
                                    <c:when test="${campaign.donation_type == 'clothes'}">
                                        <span><strong>${campaign.totalDonations}</strong> donations</span>
                                        <span>Goal: <fmt:formatNumber value="${campaign.goal_amount}" type="currency" currencySymbol="NPR " /></span>
                                    </c:when>
                                    <c:otherwise>
